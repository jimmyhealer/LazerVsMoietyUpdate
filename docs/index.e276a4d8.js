 ...
 * limitations under the License.
 */
function(t){t=Kc(t,Qc);const e=Kc(t.firestore,el);return Vc(nl(e),t._key).then((n=>vl(e,t,n)))})(Zc(wl,"setting","latest")).then((e=>{t(s)("#msg").html(e.data().version)}));break;default:t(s)("#msg").html("404")}})),o.router.init();
//# sourceMappingURL=index.e276a4d8.js.map
